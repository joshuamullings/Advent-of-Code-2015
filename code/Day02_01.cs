...
public class Day02_01
{
    public void Main()
    {
        ...
        for (int i = 0 ; i < dimentions.Count; i += 3)
        {
            ...
            // sum total
            total = total + 2 * dimentionsCalculation[0] * dimentionsCalculation[1] 
                          + 2 * dimentionsCalculation[1] * dimentionsCalculation[2]
                          + 2 * dimentionsCalculation[2] * dimentionsCalculation[0]
                              + dimentionsCalculation[0] * dimentionsCalculation[1];
        }
